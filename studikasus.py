...
def Hasil(prediction):
    if prediction == 4:
        return ("(SERIOUS) "
                ...
                "Namun, penting untuk diingat bahwa kepribadian adalah sesuatu yang kompleks dan dapat bervariasi tergantung pada situasi tertentu. Jika ada konteks khusus atau informasi tambahan, saya dapat memberikan informasi yang lebih terarah.")
    elif prediction == 3:
        return ("(RESPONSIBLE) "
